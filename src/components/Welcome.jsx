...
<div className="criterion">
  <div className="text text0">C</div>
  <div className="text text1">O</div>
  <div className="text text2">N</div>
  <div className="text text3">N</div>
  <div className="text text4">E</div>
  <div className="text text5">C</div>
  <div className="text text6">T</div>
  <div className="text text7">4</div>
